...
const Home = () => {
    return (
        ...
        <ul className={styles.list}>
            ...
            <li className={styles.card2}><Link to="/bestClient" className={styles.link}>Best Client of 2016</Link></li>
            </div>
            <div className={styles.row}>
            <li className={styles.card3}><Link to="/bestClients" className={styles.link}>Best Clients</Link></li>
